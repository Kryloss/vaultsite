...
Context file for Claude Code working on this repo. It is an INDEX: read it, then open the `docs/*.md` file the routing table names for the task at hand. Codex loads `AGENTS.md`, which carries the same body below the marker line.
