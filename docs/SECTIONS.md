...
TIL-style inline feed; async list component. The list truncates entries over 1000 markdown chars; "Continue reading" links to the entry's own page. Each entry's headings are prefixed with its own slug (#17).
